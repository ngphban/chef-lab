...
wget -P /tmp https://packages.chef.io/files/current/chef-server/12.19.44/ubuntu/16.04/chef-server-core_12.19.44-1_amd64.deb > /dev/null
dpkg -i /tmp/chef-server-core_12.19.44-1_amd64.deb
